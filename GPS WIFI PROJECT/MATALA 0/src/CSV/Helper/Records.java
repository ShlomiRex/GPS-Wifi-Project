...
public static abstract class Sort {
	/**
	 * Sort records by given rectangle. Each point inside that rectangle area
	 * will be written, any points outside that rectangle area will be ignored.
	 * @param topLeft Top left geo point.
	 * @param bottomRight Bottom right geo point.
	 */
	public static void By_Location(PrintWriter pw, Records records, GeoPoint topLeft, GeoPoint bottomRight) throws FileNotFoundException {
			...
			for(Record record : records) {
				...
				if(recordLat >= topLeft.latitude && recordLat <= bottomRight.latitude && recordLon >= topLeft.longtitude && recordLon <= bottomRight.longtitude) {
...
public static abstract class Writer {
	/**
	 * Writes to file this record class data.
	 * <br>Writes: Wigle, Headers, Records.
	 * @param pw A writer to write to.
	 * @param recordsToReadFrom Records class to write from.
	 */
	 ...
	 * @param pw PrintWriter stream.
	 * @param recordsToReadFrom Records class to read data from.
	 */
